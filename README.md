...
## Обновление интерфейса после деплоя (CSS/JS без кеша)

- Для продакшена включите в `.env`:
  - `USE_MANIFEST_STATIC_FILES=true`
...
Это включает версионирование файлов статики, поэтому браузер автоматически подхватывает новые версии интерфейса.
